...
var floorTexture = new THREE.ImageUtils.loadTexture( 'images/nav2.png' );
  var floorMaterial = new THREE.MeshBasicMaterial( { map: floorTexture, side: THREE.DoubleSide } );
  var floorGeometry = new THREE.BoxBufferGeometry(0.4, 0.4, 0.4);
  var floor = new THREE.Mesh(floorGeometry, floorMaterial);
	var gizmoTranslate = {
		...
		XYZ: [
		[ new THREE.Mesh( new THREE.OctahedronBufferGeometry( 0.2, 0 ), matWhiteTransperent ), [ 0, 0, 0 ], [ 0, 0, 0 ] ],
            [ new THREE.Mesh( arrowGeometry, matRed ), [ 0.2, 0, 0 ], [ 0, 0, -Math.PI / 2 ], null, 'fwd' ],
             [ new THREE.Mesh( arrowGeometry, matRed ), [ - 0.2, 0, 0 ], [ 0, 0, Math.PI / 2 ], null, 'fwd' ],

			[ new THREE.Mesh( arrowGeometry, matRed ), [ 0.2, 0, 0 ], [ 0, 0, Math.PI / 2 ], null, 'bwd' ],

			[ new THREE.Mesh( arrowGeometry, matGreen ), [ 0, 0.2, 0 ], null, null, 'fwd' ],
			[ new THREE.Mesh( arrowGeometry, matGreen ), [ 0, 0.2, 0 ], [ Math.PI, 0, 0 ], null, 'bwd' ],
				[ new THREE.Mesh( arrowGeometry, matBlue ), [ 0, 0, 0.2 ], [ Math.PI / 2, 0, 0 ], null, 'fwd' ],
			[ new THREE.Mesh( arrowGeometry, matBlue ), [ 0, 0, 0.2 ], [ -Math.PI / 2, 0, 0 ], null, 'bwd' ],
	...
	var gizmoRotate = {
		...
		Y: [
			...
			[ new THREE.Mesh( new THREE.OctahedronBufferGeometry( 0.09, 0 ), matGreen ), [ 0, 0, 0.99 ], null, [ 3, 1, 1 ] ],
		]/*,
		Z: [
	...
	var gizmoScale = {
		...
		XYZZ: [
		 /*[ new THREE.Mesh( arrowGeometry, matRed ), [ 0, 0, 1 ], [ 0, 0, -Math.PI / 2 ], null, 'fwd' ],
		 [ new THREE.Mesh( arrowGeometry, matGreen ), [ 1, 0, 0 ], null, null, 'fwd' ],
		 	[ new THREE.Mesh( arrowGeometry, matBlue ), [ 0, 1, 0 ], [ Math.PI / 2, 0, 0 ], null, 'fwd' ],*/
			[ new THREE.Mesh( new THREE.BoxBufferGeometry( 0.04, 1, 0.1 ), matRed ), [ 1.10, 0, 0 ] ],
			[ new THREE.Mesh( arrowGeometry, matRed), [ 1.10, -0.5, 0 ], [ Math.PI, 0, 0 ], null, 'fwd' ],
		[ new THREE.Mesh( arrowGeometry, matRed ), [ 1.10, 0.5, 0 ], [ Math.PI, 0, 0 ], null, 'fwd' ],
		[ new THREE.Mesh( arrowGeometry, matRed), [ 1.10, -0.5, 0 ], [ Math.PI, 0, 0 ], null, 'bwd' ],
		[ new THREE.Mesh( arrowGeometry, matRed ), [ 1.10, 0.5, 0 ], [ Math.PI, 0, 0 ], null, 'bwd' ],
	...
	var pickerScale = {
		...
		XYZZ: [
			[ new THREE.Mesh( new THREE.BoxBufferGeometry( 0.04, 1, 0.1 ), matInvisible ), [ 1.10, 0, 0] ],
		]
	};
